export default function Navbar() {
    ...
    <nav className="flex bg-[#A9C7F4] w-full h-[60px] px-[50px] justify-between items-center shrink-0">
      ...
      <div id="cart" className="text-black font-bold flex flex-row space-x-3">
        <a href="/cart">
          <svg
      ...
      <button
        id="user-card"
        className="my-auto flex flex-row items-center gap-x-3 rounded-xl transition-all ease-out hover:bg-button-hover active:bg-button-active dark:hover:bg-button-hover-dark dark:active:bg-button-active-dark max-sm:p-0 sm:basis-96"
      >
        <div
          id="user-avatar"
