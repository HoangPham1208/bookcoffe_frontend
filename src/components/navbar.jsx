  ...
  return (
    <>
      <div
        ...
        className="absolute top-0 right-12 my-auto box-content flex w-80  flex-col items-center space-y-5 rounded-lg  bg-white p-6 shadow-3 transition-all duration-[250ms] ease-m3-standard-decelerate dark:bg-card-background-dark max-sm:right-2 max-sm:w-10/12 z-10 "
      >
        <p className="text-left font-bold w-full">Đăng nhập</p>
        <button
          class="absolute right-5 top-0 cursor-pointer rounded-full transition-all hover:bg-[#d7e1e9] active:bg-[#b9cad8] dark:hover:bg-button-hover-dark dark:active:bg-button-active-dark"
        ...
        <FloatingLabel variant="standard" label="Tài khoản" className="w-80"/>
        <FloatingLabel variant="standard" label="Mật khẩu" className="w-80" />
