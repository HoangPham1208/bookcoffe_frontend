...
export default function BestBook() {
  ...
  return (
    <>
      ...
      <div className="flex flex-row pb-2 space-x-5 overflow-auto px-2" id="top-books-content-grid">
        {bookEntries.map((entry, index) => (
          ...
          >
            ...
            <div className="flex flex-col space-y-1 p-2" id="book-card-details">
              <p className="font-bookTitle text-lg font-bold line-clamp-2">{entry.title}</p>
              ...
              <div className="flex items-center">
                ...
                <p className="ms-2 text-xs text-gray-900 dark:text-white">{entry.rating}</p>
              </div>
            </div>
          </button>
        ))}
