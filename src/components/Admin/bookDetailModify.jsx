      ...
      <section className="mx-auto px-6 md:px-10 py-10 space-y-6 flex flex-col max-w-screen-xl pt-20">
        <main className="my-5 space-y-5">
          <div className="flex gap-5 flex-col md:flex-row">
            <div className="w-full md:w-2/12 font-semibold text-lg">
              Thêm tác giả
            </div>
          ...
          <div className="flex gap-5 flex-col md:flex-row">
            <div className="w-full md:w-2/12 font-semibold text-lg flex flex-col gap-5">
              Chỉnh sửa sách
              <div className="">
                <img
                  src={
                  ...
                  alt="bookImage"
                  className="h-40 w-28 shrink-0 border-b overflow-hidden object-cover"
                />
              </div>
            </div>
            <div className="w-full ">
